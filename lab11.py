...
def hand_rank(hand):
	...
	elif kind(4, ranks): # kan returnere både boolean og tall, i Java 0 er False || 4 of a kind
...
def straight(ranks):
	#høyeste minus laveste for å se range, og 5 ulike kort
...
def kind(nr, ranks):
	for r in ranks:
		if ranks.count(r) == nr: return r # hvis antall kort i ranks er nr, return type.
	return None
...
def test():
	...
	tp = "5D 5H TC TS 4H".split() # two pairs
	...
	assert card_ranks(sf) == [10, 9, 8, 7, 6]
        assert card_ranks(tp) == [10, 10, 5, 5, 4]
