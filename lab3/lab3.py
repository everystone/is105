...
#	byteorder: little
#	os data:
#	('Linux', 'yoda', '3.2.0-24-virtual', '#37-Ubuntu SMP Wed Apr 25 12:51:49 UTC 2012', 'i686')
#	os bruker: everystone
...
def infix_to_prefix(infix):	
	regex = r"(\d+)([\+\-/*])(\d+)"
	list = re.findall(regex, infix)
	#print "items in list: %i" % len(list)	
	#return "%i %s %i" %(list[1], list[0], list[2])
	return list
...
math = raw_input(">enter infix: ")
print infix_to_prefix(math)
